...
- "Degoogle" by removing Google Play Services. If it is a system app, you can usually disable or uninstall it for the current user via ADB.
...
| [<img src="https://github.com/woheller69/audio-analyzer-for-android/blob/master/fastlane/metadata/android/en-US/images/icon.png" width="50" alt="Audio Analyzer">](https://f-droid.org/packages/org.woheller69.audio_analyzer_for_android/) |[<img src="https://github.com/woheller69/lavatories/blob/master/fastlane/metadata/android/en-US/images/icon.png" width="50" alt="LavSeeker">](https://f-droid.org/packages/org.woheller69.lavatories/) | [<img src="https://github.com/woheller69/TimeLapseCam/blob/master/fastlane/metadata/android/en-US/images/icon.png" width="50" alt="TimeLapseCam">](https://f-droid.org/packages/org.woheller69.TimeLapseCam/) |
